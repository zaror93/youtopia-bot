"""
Bot Monitor de Canchas - Youtopia Raquet
Alertas por Telegram | Lunes-Viernes 18:00-19:00
"""
...
DIAS_VALIDOS         = [0, 1, 2, 3, 4]  # Lunes a Viernes
...
async def revisar_disponibilidad():
    ...
    async with async_playwright() as p:
        ...
        for fecha in fechas:
            try:
                ...
                # Buscar horas entre 18:00 y 18:59 en el HTML
                horas = re.findall(r'18:[0-5]\d', contenido)
                horas_unicas = list(set(horas))
    ...
    if unicas:
        log.info(f"🎾 {len(unicas)} cancha(s) encontradas!")
        for c in unicas:
            msg = (
        ...
        log.info("Sin canchas disponibles en el horario buscado")
...
if __name__ == "__main__":
    ...
    log.info(f"Revisando cada {FRECUENCIA_MINUTOS} minutos...")
    while True:
